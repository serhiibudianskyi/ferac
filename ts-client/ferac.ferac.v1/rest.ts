...
import { QueryParamsResponse } from "./types/ferac/ferac/v1/query";
import { QueryValidatorReserveResponse } from "./types/ferac/ferac/v1/query";
import { QueryRestrictedAccountResponse } from "./types/ferac/ferac/v1/query";
import { QueryRestrictedAccountsResponse } from "./types/ferac/ferac/v1/query";
import { QueryValidatorPerformanceResponse } from "./types/ferac/ferac/v1/query";

import { QueryParamsRequest } from "./types/ferac/ferac/v1/query";
import { QueryValidatorReserveRequest } from "./types/ferac/ferac/v1/query";
import { QueryRestrictedAccountRequest } from "./types/ferac/ferac/v1/query";
import { QueryRestrictedAccountsRequest } from "./types/ferac/ferac/v1/query";
import { QueryValidatorPerformanceRequest } from "./types/ferac/ferac/v1/query";
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryValidatorReserve = (
    ...
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryValidatorReserveResponse>>>({
   ...
   */
  queryRestrictedAccount = (address: string,
    query?: Record<string, any>,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryRestrictedAccountResponse>>>({
   ...
   */
  queryRestrictedAccounts = (
    query?: Omit<FlattenObject<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryRestrictedAccountsRequest>>>,"">,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryRestrictedAccountsResponse>>>({
   ...
   */
  queryValidatorPerformance = (validator_address: string,
    query?: Record<string, any>,
    params: RequestParams = {},
  ) =>
    this.request<SnakeCasedPropertiesDeep<ChangeProtoToJSPrimitives<QueryValidatorPerformanceResponse>>>({
