    ...
    fromJSON(object) {
        return {
            ...
            haltHeight: isSet(object.haltHeight)
                ? globalThis.Number(object.haltHeight)
                : isSet(object.halt_height)
                    ? globalThis.Number(object.halt_height)
                    : 0,
        };
    },
    toJSON(message) {
    ...
    fromJSON(object) {
        return {
            earliestStoreHeight: isSet(object.earliestStoreHeight)
                ? globalThis.Number(object.earliestStoreHeight)
                : isSet(object.earliest_store_height)
                    ? globalThis.Number(object.earliest_store_height)
                    : 0,
