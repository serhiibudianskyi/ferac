        ...
        return {
            ...
            signingInfos: globalThis.Array.isArray(object?.signingInfos)
                ...
                : globalThis.Array.isArray(object?.signing_infos)
                    ? object.signing_infos.map((e) => SigningInfo.fromJSON(e))
                    : [],
            missedBlocks: globalThis.Array.isArray(object?.missedBlocks)
                ...
                : globalThis.Array.isArray(object?.missed_blocks)
                    ? object.missed_blocks.map((e) => ValidatorMissedBlocks.fromJSON(e))
                    : [],
        };
    },
    toJSON(message) {
    ...
    fromJSON(object) {
        return {
            ...
            missedBlocks: globalThis.Array.isArray(object?.missedBlocks)
                ...
                : globalThis.Array.isArray(object?.missed_blocks)
                    ? object.missed_blocks.map((e) => MissedBlock.fromJSON(e))
                    : [],
        };
    },
    toJSON(message) {
