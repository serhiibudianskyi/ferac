        ...
        return {
            ...
            extensionRange: globalThis.Array.isArray(object?.extensionRange)
                ...
                : globalThis.Array.isArray(object?.extension_range)
                    ? object.extension_range.map((e) => DescriptorProto_ExtensionRange.fromJSON(e))
                    : [],
            ...
            reservedRange: globalThis.Array.isArray(object?.reservedRange)
                ...
                : globalThis.Array.isArray(object?.reserved_range)
                    ? object.reserved_range.map((e) => DescriptorProto_ReservedRange.fromJSON(e))
                    : [],
    ...
    fromJSON(object) {
        return {
            ...
            reservedRange: globalThis.Array.isArray(object?.reservedRange)
                ...
                : globalThis.Array.isArray(object?.reserved_range)
                    ? object.reserved_range.map((e) => EnumDescriptorProto_EnumReservedRange.fromJSON(e))
                    : [],
            reservedName: globalThis.Array.isArray(object?.reservedName)
                ? object.reservedName.map((e) => globalThis.String(e))
                : globalThis.Array.isArray(object?.reserved_name)
        ...
        return {
            ...
            editionDefaults: globalThis.Array.isArray(object?.editionDefaults)
                ...
                : globalThis.Array.isArray(object?.edition_defaults)
                    ? object.edition_defaults.map((e) => FieldOptions_EditionDefault.fromJSON(e))
                    : [],
            features: isSet(object.features) ? FeatureSet.fromJSON(object.features) : undefined,
    ...
    fromJSON(object) {
        return {
            ...
            enforceProtoLimits: isSet(object.enforceProtoLimits)
                ...
                : isSet(object.enforce_proto_limits)
                    ? featureSet_ProtoLimitsFeature_EnforceProtoLimitsFromJSON(object.enforce_proto_limits)
                    : 0,
        };
    },
    toJSON(message) {
...
export const FeatureSet_ProtoLimitsFeature = {
    ...
    create(base) {
        return FeatureSet_ProtoLimitsFeature.fromPartial(base ?? {});
    },
    fromPartial(_) {
        const message = createBaseFeatureSet_ProtoLimitsFeature();
        return message;
