    ...
    fromJSON(object) {
        return {
            ...
            memberUpdates: globalThis.Array.isArray(object?.memberUpdates)
                ...
                : globalThis.Array.isArray(object?.member_updates)
                    ? object.member_updates.map((e) => MemberRequest.fromJSON(e))
                    : [],
        };
    },
    toJSON(message) {
    ...
    fromJSON(object) {
        return {
            ...
            groupMetadata: isSet(object.groupMetadata)
                ? globalThis.String(object.groupMetadata)
                : isSet(object.group_metadata)
                    ? globalThis.String(object.group_metadata)
                    : "",
            groupPolicyMetadata: isSet(object.groupPolicyMetadata)
                ? globalThis.String(object.groupPolicyMetadata)
                : isSet(object.group_policy_metadata)
                    ? globalThis.String(object.group_policy_metadata)
                    : "",
            groupPolicyAsAdmin: isSet(object.groupPolicyAsAdmin)
                ? globalThis.Boolean(object.groupPolicyAsAdmin)
                : isSet(object.group_policy_as_admin)
