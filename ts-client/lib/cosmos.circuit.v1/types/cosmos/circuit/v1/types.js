    ...
    fromJSON(object) {
        return {
            ...
            limitTypeUrls: globalThis.Array.isArray(object?.limitTypeUrls)
                ...
                : globalThis.Array.isArray(object?.limit_type_urls)
                    ? object.limit_type_urls.map((e) => globalThis.String(e))
                    : [],
        };
    },
    toJSON(message) {
    ...
    fromJSON(object) {
        return {
            accountPermissions: globalThis.Array.isArray(object?.accountPermissions)
                ...
                : globalThis.Array.isArray(object?.account_permissions)
                    ? object.account_permissions.map((e) => GenesisAccountPermissions.fromJSON(e))
                    : [],
            disabledTypeUrls: globalThis.Array.isArray(object?.disabledTypeUrls)
                ? object.disabledTypeUrls.map((e) => globalThis.String(e))
                : globalThis.Array.isArray(object?.disabled_type_urls)
                    ? object.disabled_type_urls.map((e) => globalThis.String(e))
                    : [],
        };
    },
    toJSON(message) {
