module github.com/serhiibudianskyi/ferac
...
replace github.com/bufbuild/buf => github.com/bufbuild/buf v1.49.0

replace github.com/bufbuild/protovalidate-go => github.com/bufbuild/protovalidate-go v0.6.5
